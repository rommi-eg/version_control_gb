...
Команда выводит информацию об одном из удалённых репозиториев.
...
Команда служит для переименования удалённого репозитория.
...
Команда удалит удалённый репозиторий.

```sh
git remote remove <имя_репозитория>
```

*\* **Примечание**: При удалении ссылки на удалённый репозиторий все отслеживаемые ветки и настройки, связанные с этим репозиторием, так же будут удалены.*
